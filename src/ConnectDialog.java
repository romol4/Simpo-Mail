...
public class ConnectDialog extends JDialog {
    ...
    public ConnectDialog(Frame parent) {
        ...
        try {
            ...
            serverTextField.setText(prop.getProperty("server"));
            usernameTextField.setText(prop.getProperty("user"));
            passwordField.setText(prop.getProperty("password"));
            smtpServerTextField.setText(prop.getProperty("smtp"));
